...
class awz_mailtomax extends CModule
{
	var $MODULE_ID = "awz.mailtomax";
	var $MODULE_VERSION;
    ...
    public function __construct()
	{
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_MAILTOMAX_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_MAILTOMAX_MODULE_DESCRIPTION");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("AWZ_MAILTOMAX_MODULE_NAME"),
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) {
            $APPLICATION->IncludeAdminFile(
                Loc::getMessage('AWZ_MAILTOMAX_INSTALL_TITLE'),
    ...
    function InstallEvents()
    {
        ...
        $eventManager->registerEventHandlerCompatible(
            ...
            $this->MODULE_ID, '\\Awz\\Mailtomax\\Access\\Handlers', 'OnAfterUserUpdate'
        );
        $eventManager->registerEventHandlerCompatible(
            'main', 'OnAfterUserAdd',
            $this->MODULE_ID, '\\Awz\\Mailtomax\\Access\\Handlers', 'OnAfterUserUpdate'
    ...
    {
        CopyDirFiles(
            $_SERVER['DOCUMENT_ROOT']."/bitrix/modules/".$this->MODULE_ID."/install/components/mailtomax.config.permissions/",
            $_SERVER['DOCUMENT_ROOT']."/bitrix/components/awz/mailtomax.config.permissions",
            true, true
        );
        return true;
    }
    ...
    {
        DeleteDirFilesEx("/bitrix/components/awz/mailtomax.config.permissions");
        return true;
    }
