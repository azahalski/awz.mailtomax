...
use Awz\Mailtomax\Access\Custom\ComponentConfig;
                ...
                window.awz_right_dialog = {
                    ...
                    reloadItems: function(items, event){
                        ...
                        items.forEach(function(itm){
                            if(itm.getEntityId()==='user' || itm.getEntityType()==='awzmailtomax-user'){
                                let itmEv = {
                                    type: 'users',
                                    id: 'U'+itm.getId(),
                                    key: 'U'+itm.getId(),
                            ...
                            }else if(itm.getEntityType()==='awzmailtomax-group'){
                                let itmEv = {
                                    type: 'groups',
                                    id: 'G'+itm.getId(),
                                    key: 'G'+itm.getId(),
                    ...
                    load: function(groupKey, options){
                        ...
                        if(groupData.hasOwnProperty('members')){
                            for(k in groupData['members']){
                                ...
                                if(itm.type==='users'){
                                    preselectedItems.push(['awzmailtomax-user',itm.id]);
                                }
                                else if(itm.type==='awzmailtomax-user'){
                                    preselectedItems.push(['awzmailtomax-user',itm.id]);
                                }
                                else if(itm.type==='awzmailtomax-group'){
                                    preselectedItems.push(['awzmailtomax-group',itm.id]);
                                }
                        ...
                        this.dialog = new BX.UI.EntitySelector.Dialog({
                            ...
                            entities: [
                                {
                                    id: 'awzmailtomax-user',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
                                {
                                    id: 'awzmailtomax-group',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
