...
class Helper {
    ...
    public static function sendMax(string $mess): Result
    {
        $result = new Result();
        $tokenAr = array(
    ...
    /**
     * Конвертирует HTML/Markdown в текст для Макс и жестко ограничивает длину до лимита API.
     * Поддерживаемые теги: <b>, <strong>, <i>, <em>, <u>, <s>, <strike>, <code>, <pre>, <a>
     *
     * @param string $html
     * @param int $maxLength Максимальная длина сообщения (безопасный лимит для Макс — 3800)
     * @return string
     */
