...
use Awz\Mailtomax\Access\Custom\ActionDictionary;
...
$aMenu[] = array(
    ...
    "sort" => 100,
    "module_id" => $module_id,
    "text" => Loc::getMessage('AWZ_ADMIN_MENU_NAME_AWZ_MAILTOMAX'),
    "title" => Loc::getMessage('AWZ_ADMIN_MENU_NAME_AWZ_MAILTOMAX'),
